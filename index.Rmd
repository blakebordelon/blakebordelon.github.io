...
### Recent News
+ Papers to appear at ICLR 2023 on [learning rule dependence of feature dynamics](https://openreview.net/forum?id=nZ2NtpolC5-) and the [deviations of infinite width behavior](https://openreview.net/forum?id=JLINxPOVTh7) in finite network learning curves.
+ Study of sample efficient learning from [population codes](https://elifesciences.org/articles/78606) is now published at Elife.
+ Our work on [dynamical field theory](https://openreview.net/forum?id=sipwrPCrIS) for infinite width feature learning neural networks appeared at *Neurips* 2022.  
