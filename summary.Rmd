...
![Learning Curves for Gaussian Data and MNIST](spectrum_learning_curves.png){width=50%}
...
![Kernel Evolution](kernel_alignment.png){width=50%}
...
![SGD Learning Curves for Random Feature Models](sgd_plot.png){width=50%}
...
![SGD Learning Curves for Random Feature Models](SVD_neural_code.png){width=50%}
![The inductive Bias of Resevoir Computers](RNN_model.png){width=50%}
